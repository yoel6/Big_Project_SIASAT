    ...
    <nav id="sidebar" class="sidebar-wrapper">
      ...
      <main class="page-content">
        <div class="container-fluid">
          <h5><img class="ml-3" src="http://localhost:8000//logo.png" alt="Image" height="100" width="100"> Registrasi Matakuliah</h5>
          ...
          <table class="table">
            ...
            ?>
             @foreach($kelompok as $b)
              @if($b->prodi == $prodi && $b->sks > 0 )
                 <tr>
                  <td>{{$no++}}</td>
                  <td>{{$b->matkul}}</td>
                  <td>{{$b->sks}}</td>
                  <td><a href="/siasat/lengkap/{{$b->kodematkul}}">{{$b->kodematkul}}</a></td>
                </tr>
              @endif
            @endforeach
          </tbody>
