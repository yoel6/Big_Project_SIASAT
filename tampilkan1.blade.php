    ...
    <nav id="sidebar" class="sidebar-wrapper">
      ...
      <main class="page-content">
        <div class="container-fluid">
          <h5><img class="ml-3" src="http://localhost:8000//logo.png" alt="Image" height="100" width="100">Daftar Kelas</h5>
            ...
            ?>
             @foreach($je as $b)
                 <tr>
                  ...
                  <?php $_SESSION['nama_mahasiswa']= $b->nama_mahasiswa; ?>
                  <td><a href="/siasat/nilai/{{$b->kode}}">Masukkan Nilai</a></td>
                </tr>
