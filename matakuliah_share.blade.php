    ...
    <nav id="sidebar" class="sidebar-wrapper">
      ...
      <main class="page-content">
        <div class="container-fluid">
          <h5><img class="ml-3" src="http://localhost:8000//logo.png" alt="Image" height="100" width="100">Matakuliah Share</h5>
          ...
          <?php $no=1;
          $prodi = $_SESSION['fakultas'];
          ?>
          @foreach($kelompok1 as $b)
          @if($b->prodi != $prodi )
          <thead class="thead-white">
            <tr>
              <th scope="col">{{$b->prodi}}</th>
              <th></th>
              <th></th>
              <th></th>
            </tr>
          ...
          <tbody>
           <tr>
            ...
            <td>{{$b->matkul}}</td>
            <td>{{$b->sks}}</td>
            <td><a href="/siasat/matkul/{{$b->kodematkul}}">{{$b->kodematkul}}</a></td>
          </tr>
          @endif
          @endforeach
        </tbody>
